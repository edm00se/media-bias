...
#         hashtag_list.extend(json.loads(tweet.hashtags))
#         print hashtag_list
...
def senator_data(request, pk):
    ...
    return render(request, 'TwitterData/senator_data.html', {'senator':senator_data, 'twitter_url':twitter_url, 'tweets':tweets, 'tweet_count':tweet_count, 'avg_polarity':avg_polarity, 'most_used_words':most_used_words})
